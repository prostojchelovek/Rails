...
class BadgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create badge" do
    assert_difference('Badge.count') do
      post badges_url, params: { badge: { name: @badge.name, parameter: @badge.parameter, picture: @badge.picture, rule: @badge.rule } }
    end
  ...
  test "should update badge" do
    patch badge_url(@badge), params: { badge: { name: @badge.name, parameter: @badge.parameter, picture: @badge.picture, rule: @badge.rule } }
